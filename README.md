...
저장소 소유자·멤버·협업자가 open issue에 새 댓글을 달면 예약 실행을 기다리지 않고 댓글 본문을 검색어로 즉시 처리합니다. GitHub Actions 봇이 작성한 결과 댓글과 외부 사용자의 댓글은 새 검색을 트리거하지 않습니다. 각 사용자 댓글은 댓글 ID와 내용의 해시로 한 번만 처리됩니다.
